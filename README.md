...
Bar chart shows distribution of Lehigh University undergraduate population across colleges. <br/>
Chart by Jamie Marshaleck, Lehigh University '26. <br/>

## Graded Bar Chart Assignment - 10/10/2024 <br/>
![nyGrad](https://github.com/jm326/jm326.github.io/blob/main/barchartNYGrads.png?raw=true) <br/>
Bar chart shows graduation outcome of New York High School Students from cohorts of 2012-2019. <br/>
Chart by Jamie Marshaleck, Lehigh University '26. <br/>

## In-Class Line Chart Assignment - 10/15/2024 <br/>
![timeseriesCollege](https://github.com/jm326/jm326.github.io/blob/main/timeseriesCollege.png?raw=true) <br/>
Time series shows the percentage of Lehigh University undergraduate population in each college over time from 2016-2020. <br/>
Graph by Jamie Marshaleck, Lehigh University '26. <br/>
![scatterplotGDP](https://github.com/jm326/jm326.github.io/blob/main/scatterPlotGDP.png?raw=true) <br/>
Scatter plot shows a correlation between a nation's GDP per capita and its Life Satisfaction in Cantril Ladder. <br/>
Graph by Jamie Marshaleck, Lehigh University '26. <br/>

## Graded Line Chart Assignment - 10/15/2024 <br/>
![timeseriesGoogle](https://github.com/jm326/jm326.github.io/blob/main/timeseriesGoogle.png?raw=true) <br/>
Time series shows increased interest in the search term "election" on years in which a US presidential election is being held. <br/>
Graph by Jamie Marshaleck, Lehigh University '26. <br/>

## Google My Maps Assignment - 10/24/2024 <br/>
<iframe src="https://www.google.com/maps/d/u/0/embed?mid=1Y9nYW-zYQ9rRU2VQmK89Co13tYp9PA0&ehbc=2E312F" width="640" height="480"></iframe>
Map of the most popular or unique coffee shops in Southside Bethlehem, Pennsylvania. Students of Lehigh University and residents of the Southside frequent these coffee shops, which all serve amazing brews! <br/>
Map by Jamie Marshaleck, Lehigh University '26. <br/>
...
Visualization shows how life expectancy and common cause of death differs by state. It would be interesting to compare the map of life expectancy to a map of average income or highest education received because I believe there will be a correlation there (as this looks similar to a map of the electoral college). The two most common causes of death in the United States are heart disease and cancer; because they are chronic diseases, this showcases the high advancement of the United States on the world stage. Adjusting the filter to show only states with higher or lower numbers of deaths will show states with high or low populations, as the data is total deaths, not a ratio. This makes for interesting analysis, as it seems that states with lower populations may have lower life expectancy (though this is not entirely accurate).<br/>
Infographic by Jamie Marshaleck, Lehigh University '26. <br/>
